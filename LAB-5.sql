...
EXEC sp_rename 'DEPOSIT.BNAME' , 'BRANCH'
...
ALTER TABLE DEPOSIT_DETAIL
ALTER COLUMN BRANCH VARCHAR(30)
...
DELETE FROM BANK_DEPOSIT
WHERE BALANCE = 7000 AND CUSTOMER_NAME = 'CHARMI' AND BRANCH = 'SHITAL PARK'
